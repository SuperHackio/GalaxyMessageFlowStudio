...
namespace ST.Library.UI.NodeEditor
{
    ...
    public class STNodePropertyDescriptor
    {
        ...
        protected internal virtual object GetValueFromString(string strText) {
            ...
            if (t == m_t_int) return int.Parse(strText, System.Globalization.NumberStyles.AllowThousands);
            if (t == m_t_float) return float.Parse(strText, System.Globalization.NumberStyles.AllowThousands);
            if (t == m_t_double) return double.Parse(strText, System.Globalization.NumberStyles.AllowThousands);
